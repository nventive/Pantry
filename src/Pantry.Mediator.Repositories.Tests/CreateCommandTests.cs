...
namespace Pantry.Mediator.Repositories.Tests
{
    public class CreateCommandTests
    {
        ...
        {
            var eventHandler = new Mock<IDomainEventHandler<EntityAddedDomainEvent<StandardEntity>>>();
            var services = new ServiceCollection()
                ...
                .Services
                .AddMediator()
                .TryAddRepositoryHandler<CreateStandardEntity>()
                .AddSingleton(eventHandler.Object)
            ...
            eventHandler.Verify(x => x.HandleAsync(It.IsAny<EntityAddedDomainEvent<StandardEntity>>()));
        }
        ...
        public async Task ItShouldCreateAndReturnModel()
        {
            ...
            var services = new ServiceCollection()
                ...
                .Services
                .AddMediator()
                .TryAddRepositoryHandler<CreateAndProjectStandardEntity>()
                .AddSingleton(eventHandler.Object)
                .BuildServiceProvider();
