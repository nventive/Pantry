...
namespace Pantry.AspNetCore.Controllers
{
    ...
    public abstract class RepositoryController<TEntity, TInputModel> : RepositoryController<TEntity, TEntity, TEntity, TInputModel, TInputModel, CriteriaRepositoryQuery<TEntity>>
