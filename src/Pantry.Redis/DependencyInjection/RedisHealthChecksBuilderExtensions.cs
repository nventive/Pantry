...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    {
        /// <summary>
        /// Adds a health check for <see cref="RedisRepository{TEntity}"/>.
        /// </summary>
        ...
        public static IHealthChecksBuilder AddRedisRepositoryCheck<TEntity>(
            ...
            where TEntity : class, IIdentifiable, new()
        {
            ...
            return builder.Add(
                new HealthCheckRegistration(
                    name ?? typeof(RedisRepository<TEntity>).FullName,
                    sp => sp.GetRequiredService<RedisRepository<TEntity>>(),
                    failureStatus,
                    tags));
        }
    }
